...
const Data = ({role, name, surname, nick, exp, lvl, editNickLoad, checkPattern, patternNotify, setQuitModal}) => {
	...
	return(
		<>
			...
			<Box className={`${gstyle.flexstart} ${gstyle.w100}`} sx={{mt: 3}}>
				...
				<Button color="error" variant="contained" sx={{mt: 1}} className={gstyle.w100} onClick={() => setQuitModal(true)}>
					Выйти с аккаунта
				</Button>
			</Box>
		</>
...
export default connect(mapStateToProps, {checkPattern, patternNotify, setQuitModal})(Data);