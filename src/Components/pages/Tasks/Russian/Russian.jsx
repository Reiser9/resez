			...
			<TabContext value={tab}>
		        ...
		        <TabPanel value="1">
		        	<div className="tasks__item flexstart w100">
		        		...
		        		<div className="tasks__item--title w100">
		        			<span className="bold">Формулировка задания: </span> Укажите варианты ответов, в которых даны верные характеристики 
		        ...
		        <TabPanel value="2">
		        	<div className="tasks__item flexstart w100">
		        		...
		        		<div className="tasks__item--title w100">
		        			<span className="bold">Формулировка задания: </span> Самостоятельно подберите (какую-то часть речи), которое должно стоять на месте 
		        			пропуска в n-ом предложении текста. Запишите это местоимение.
		        		</div>
		        		...
		        		<div className="tasks__item--content flexstart w100">
		        			<div className="tasks__table--item w100">
		        				...
		        				<div className="tasks__table--content">
		        					<p className="tasks__table--text">
		        						<span className="bold">Уверенность:</span> конечно, разумеется, бесспорно, несомненно, безусловно, действительно, естественно, правда, в самом деле и др.
		        					</p>

		        					<p className="tasks__table--text">
		        						<span className="bold">Неуверенность, предположение:</span> кажется, может быть, вероятно, очевидно, возможно, пожалуй, по-видимому, надо полагать, я думаю, надеюсь, полагаю, верно, должно быть, если я не ошибаюсь и др.
		        					</p>

		        					<p className="tasks__table--text">
		        						<span className="bold">Различные чувства:</span> к счастью, к удивлению, странное дело, нечего греха таить, к ужасу, к прискорбию, к общей радости и др.
		        					</p>

		        					<p className="tasks__table--text">
		        						<span className="bold">Источник сообщения:</span> передают, говорят, слышно, как известно, по-моему, по сообщению, на мой взгляд, по словам, помнится и др.
		        					</p>

		        					<p className="tasks__table--text">
		        						<span className="bold">Оформление мыслей:</span> во-первых, значит, итак, следовательно, словом, наконец, точнее, короче говоря, лучше сказать, наоборот, например, между прочим, кстати, таким образом, с одной стороны и др.
		        					</p>

		        					<p className="tasks__table--text">
		        						<span className="bold">Ссылка на обычность:</span> как всегда, по обычаю, по обыкновению, бывает, случается, бывало, как водится и др.
		        					</p>

		        					<p className="tasks__table--text">
		        						<span className="bold">Оценка меры сообщаемого:</span> самое большее, самое меньшее, по крайней мере, без преувеличений и др.
		        					</p>

		        					<p className="tasks__table--text">
		        						<span className="bold">Выражение экспрессии:</span> по правде, кроме шуток, по совести, по справедливости, надо признаться, сказать по чести, между нами говоря и др.
		        					</p>

		        					<p className="tasks__table--text">
		        						<span className="bold">Привлечение внимания:</span> пожалуйста, извините, послушайте, представьте себе, скажем, предположим, поверь, веришь ли и др.
		        					</p>
		        				</div>
		        			</div>
		        			...
		        			<div className="tasks__table--item w100">
		        				...
		        				<div className="tasks__table--content">
		        					<p className="tasks__table--text">
		        						<span className="bold">Что,</span> как, чтобы, будто, ли(частица в роли союза)
		        					</p>

		        					<p className="tasks__table--text">
		        						<span className="bold">Когда,</span> в то время как, как только, между тем как, лишь, лишь только, едва лишь, пока
		        					</p>

		        					<p className="tasks__table--text">
		        						<span className="bold">Потому что,</span> оттого что, ибо, так как, из-за того что, благодаря тому что, вследствие того что, в связи с тем что
		        					</p>

		        					<p className="tasks__table--text">
		        						<span className="bold">Чтобы(чтоб),</span> дабы, для того чтобы, с тем чтобы
		        					</p>

		        					<p className="tasks__table--text">
		        						<span className="bold">Если(если то),</span> если бы, ежели, ежели бы, коли(коль), когда, когда бы, раз
		        					</p>

		        					<p className="tasks__table--text">
		        						<span className="bold">Хотя(хоть),</span> хотя бы, пусть, даром что, несмотря ни на что, невзирая на то что
		        					</p>

		        					<p className="tasks__table--text">
		        						<span className="bold">Как,</span> как бы, как будто, будто, будто бы, словно, словно как, точно
		        					</p>

		        					<p className="tasks__table--text">
		        						<span className="bold">Так что</span>
		        					</p>
		        				</div>
		        			</div>
		        			...
		        			<div className="tasks__table--item w100">
		        				...
		        				<div className="tasks__table--content">
		        					<p className="tasks__table--text">
		        						<span className="bold">Соединительные:</span> и, да(в значении "и"), тоже, также, ни ... ни, не только ... но и, если не ... то, не столько ... сколько, как ... так и, не то что ... а, хотя и ... но
		        					</p>

		        					<p className="tasks__table--text">
		        						<span className="bold">Противительные:</span> а, да (в значении "но"), но, однако, зато, же, только(в значении "но")
		        					</p>

		        					<p className="tasks__table--text">
		        						<span className="bold">Разделительные:</span> или, либо, то ... то, не то ... не то, то ли ... то ли
		        					</p>
		        				</div>
		        			</div>
		        		</div>
		        ...
		        <TabPanel value="3">
		        	<div className="tasks__item flexstart w100">
		        		...
		        		<div className="tasks__item--title w100">
		        			<span className="bold">Формулировка задания: </span> Прочитайте фрагмент словарной статьи, в которой приводятся значения слова, выделенного 
